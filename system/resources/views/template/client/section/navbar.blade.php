                            ...
                            <nav class="navbar navbar-expand-md navbar-light">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav ml-auto py-4 py-md-0">
                                        ...
                                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4"> <a class="nav-link" href="{{ url('faqs') }}">FAQs</a> </li>
                                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4"> <a class="nav-link" href="{{ url('contact') }}">Contact</a> </li>
                                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4"> <a class="nav-link" href="{{ url('blog') }}">Blog</a> </li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
